...
contract SwapExamples {
    ...
    function swapExactInputSingle2(uint256 amountIn) external returns (uint256 amountOut) {
    ...
    function swapExactOutputSingle2(uint256 amountOut, uint256 amountInMaximum) external returns (uint256 amountIn) {
        // Transfer the specified amount of DAI to this contract.
